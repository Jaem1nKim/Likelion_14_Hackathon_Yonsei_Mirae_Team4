...
const productSeeds = [
  ...
  },
  {
    ...
    sku: "DEMO-APP-001",
    name: "Demo Structured Travel Jacket",
    ...
    description: "A structured demo jacket designed to extend a practical travel look.",
  ...
  },
  {
    ...
    sku: "DEMO-APP-002",
    name: "Demo Ivory Motion Blouson",
    category: ProductCategory.APPAREL,
    color: "IVORY",
    ...
    description: "A light demo blouson that creates contrast while keeping an easy silhouette.",
  ...
  },
  {
    ...
    sku: "DEMO-APP-003",
    name: "Demo Cobalt Contrast Vest",
    category: ProductCategory.APPAREL,
    color: "COBALT",
    ...
    description: "A high-contrast demo vest for a more expressive layered direction.",
  ...
  },
  {
    ...
    sku: "DEMO-ACC-001",
    name: "Demo Classic Reversible Belt",
    ...
    description: "A reversible demo belt connecting black and brown styling choices.",
  ...
  },
  {
    ...
    description: "A vivid demo scarf that adds a controlled contrast to the final look.",
  ...
  },
  {
    ...
    description: "A modular demo detail that changes how a selected bag is carried and read.",
